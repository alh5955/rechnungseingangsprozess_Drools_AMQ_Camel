/**
 * InvoiceServicePortBindingStub.java
 *
...
public class InvoiceServicePortBindingStub extends org.apache.axis.client.Stub implements edu.thi.jpa.ws.InvoiceService {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://ws.jpa.thi.edu/", "invoice"));
        oper.setReturnClass(edu.thi.jpa.ws.Invoice.class);
    ...
    public InvoiceServicePortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public InvoiceServicePortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public InvoiceServicePortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://ws.jpa.thi.edu/", "invoice");
            cachedSerQNames.add(qName);
            cls = edu.thi.jpa.ws.Invoice.class;
